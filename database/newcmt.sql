...
CREATE TABLE `ba_admin_log`  (
  ...
  `create_time` bigint(16) UNSIGNED NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员日志表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 104 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '菜单和权限规则表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `ba_attachment` VALUES (1, 'default', 1, 0, '/storage/default/20260127/PixPin_2026-01-e9a7c888a790b00f8ad721e3e0911e41265ede35.png', 334, 260, 'PixPin_2026-01-26_14-31-25.png', 203516, 'image/png', 1, 'local', 'e9a7c888a790b00f8ad721e3e0911e41265ede35', 1769499784, 1769499784);
