...
const baTable = new baTableClass(
    new baTableApi('/admin/ticketuser.TicketUser/'),
    {
        ...
        column: [
            ...
            { label: t('ticketuser.ticketUser.id'), prop: 'id', align: 'center', width: 70, operator: 'eq', sortable: 'custom' },
            {
            ...
            { label: t('ticketuser.ticketUser.created_at'), prop: 'created_at', align: 'center', operator: false, sortable: 'custom', width: 160 },
            { label: t('ticketuser.ticketUser.updated_at'), prop: 'updated_at', align: 'center', operator: false, sortable: 'custom', width: 160 },
