...
const baTable = new baTableClass(
    new baTableApi('/admin/ticketuser.UserProfile/'),
    {
        ...
        column: [
            ...
            { label: t('ticketuser.userProfile.user_id'), prop: 'user_id', align: 'center', operatorPlaceholder: t('Fuzzy query'), operator: 'LIKE' },
            {
            ...
            { label: t('ticketuser.userProfile.id_card1_image'), prop: 'id_card1_image', align: 'center', render: 'image', operator: false },
            { label: t('ticketuser.userProfile.id_card2_image'), prop: 'id_card2_image', align: 'center', render: 'image', operator: false },
            { label: t('ticketuser.userProfile.wechat_qr_image'), prop: 'wechat_qr_image', align: 'center', render: 'image', operator: false },
            { label: t('ticketuser.userProfile.alipay_qr_image'), prop: 'alipay_qr_image', align: 'center', render: 'image', operator: false },
